import os
import datetime
from app.config import DB_USER, DB_PASSWORD, DB_NAME, BACKUP_DIR, MYSQLDUMP_PATH
...
def backup_db():
    ...
    if result != 0:
        raise Exception(f"Backup gagal. Pastikan database aktif dan path {dump_bin} benar.")
